...
class TestOptimizer(unittest.TestCase):
    ...
    # multiple, 1 ea
    def test_32(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 10, "qty": 1}, {"uid": "big bag bully sticks", "weight": 14, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        for box in response.boxes:
    ...
    def test_33(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 8, "qty": 1}, {"uid": "sample bully sticks", "weight": 6, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Mail Innovations')
    ...
    def test_34(self):
        input_data = {"zip": "64231", "items": [{"uid": "kong filler", "weight": 32, "qty": 1}, {"uid": "bigger bag bully sticks", "weight": 32, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Mail Innovations')
    ...
    def test_35(self):
        input_data = {"zip": "64231", "items": [{"uid": "bulk bully sticks", "weight": 72, "qty": 1}, {"uid": "bulk kong filler", "weight": 72, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Ground')
    ...
    def test_36(self):
        input_data = {"zip": "64231", "items": [{"uid": "massive bulk bully sticks", "weight": 160, "qty": 1}, {"uid": "massive bulk kong filler", "weight": 160, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Ground')
    ...
    def test_42(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 10, "qty": 1, "force_ground": True}, {"uid": "big bag bully sticks", "weight": 14, "qty": 1, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        for box in response.boxes:
    ...
    def test_43(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 8, "qty": 1, "force_ground": True}, {"uid": "sample bully sticks", "weight": 6, "qty": 1, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        for box in response.boxes:
    ...
    def test_44(self):
        input_data = {"zip": "64231", "items": [{"uid": "kong filler", "weight": 32, "qty": 1, "force_ground": True}, {"uid": "bigger bag bully sticks", "weight": 32, "qty": 1, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        for box in response.boxes:
    ...
    def test_45(self):
        input_data = {"zip": "64231", "items": [{"uid": "bulk bully sticks", "weight": 72, "qty": 1, "force_ground": True}, {"uid": "bulk kong filler", "weight": 72, "qty": 1, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        for box in response.boxes:
    ...
    def test_46(self):
        input_data = {"zip": "64231", "items": [{"uid": "massive bulk bully sticks", "weight": 160, "qty": 1, "force_ground": True}, {"uid": "massive bulk kong filler", "weight": 160, "qty": 1, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        for box in response.boxes:
    ...
    def test_52(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 10, "qty": 1, "force_ground": True}, {"uid": "big bag bully sticks", "weight": 14, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
    ...
    def test_53(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 8, "qty": 1, "force_ground": True}, {"uid": "sample bully sticks", "weight": 6, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        self.assertEqual(len([box for box in response.boxes if box.shipping_method == 'UPS Ground']), 1)
    ...
    def test_54(self):
        input_data = {"zip": "64231", "items": [{"uid": "kong filler", "weight": 32, "qty": 1, "force_ground": True}, {"uid": "bigger bag bully sticks", "weight": 32, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        self.assertEqual(len([box for box in response.boxes if box.shipping_method == 'UPS Ground']), 1)
    ...
    def test_55(self):
        input_data = {"zip": "64231", "items": [{"uid": "bulk bully sticks", "weight": 72, "qty": 1, "force_ground": True}, {"uid": "bulk kong filler", "weight": 72, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
    ...
    def test_56(self):
        input_data = {"zip": "64231", "items": [{"uid": "massive bulk bully sticks", "weight": 160, "qty": 1, "force_ground": True}, {"uid": "massive bulk kong filler", "weight": 160, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        self.assertEqual(len([box for box in response.boxes if box.shipping_method == 'UPS Ground']), 2)
    ...
    # multiple items, >1 ea
    def test_62(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 10, "qty": 3}, {"uid": "big bag bully sticks", "weight": 14, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Ground')
    ...
    def test_63(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 8, "qty": 3}, {"uid": "sample bully sticks", "weight": 6, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Mail Innovations')
    ...
    def test_64(self):
        input_data = {"zip": "64231", "items": [{"uid": "kong filler", "weight": 32, "qty": 3}, {"uid": "bigger bag bully sticks", "weight": 32, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Ground')
    ...
    def test_65(self):
        input_data = {"zip": "64231", "items": [{"uid": "bulk bully sticks", "weight": 72, "qty": 3}, {"uid": "bulk kong filler", "weight": 72, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Ground')
    ...
    def test_66(self):
        input_data = {"zip": "64231", "items": [{"uid": "massive bulk bully sticks", "weight": 160, "qty": 3}, {"uid": "massive bulk kong filler", "weight": 160, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Ground')
    ...
    def test_72(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 10, "qty": 3, "force_ground": True}, {"uid": "big bag bully sticks", "weight": 14, "qty": 3, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 6)
        for box in response.boxes:
    ...
    def test_73(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 8, "qty": 3, "force_ground": True}, {"uid": "sample bully sticks", "weight": 6, "qty": 3, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 6)
        for box in response.boxes:
    ...
    def test_74(self):
        input_data = {"zip": "64231", "items": [{"uid": "kong filler", "weight": 32, "qty": 3, "force_ground": True}, {"uid": "bigger bag bully sticks", "weight": 32, "qty": 3, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 6)
        for box in response.boxes:
    ...
    def test_75(self):
        input_data = {"zip": "64231", "items": [{"uid": "bulk bully sticks", "weight": 72, "qty": 3, "force_ground": True}, {"uid": "bulk kong filler", "weight": 72, "qty": 3, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 6)
        for box in response.boxes:
    ...
    def test_76(self):
        input_data = {"zip": "64231", "items": [{"uid": "massive bulk bully sticks", "weight": 160, "qty": 3, "force_ground": True}, {"uid": "massive bulk kong filler", "weight": 160, "qty": 3, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 6)
        for box in response.boxes:
    ...
    def test_82(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 10, "qty": 3, "force_ground": True}, {"uid": "big bag bully sticks", "weight": 14, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 4)
    ...
    def test_83(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 8, "qty": 3, "force_ground": True}, {"uid": "sample bully sticks", "weight": 6, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
    ...
    def test_84(self):
        input_data = {"zip": "64231", "items": [{"uid": "kong filler", "weight": 32, "qty": 3, "force_ground": True}, {"uid": "bigger bag bully sticks", "weight": 32, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 4)
    ...
    def test_85(self):
        input_data = {"zip": "64231", "items": [{"uid": "bulk bully sticks", "weight": 72, "qty": 3, "force_ground": True}, {"uid": "bulk kong filler", "weight": 72, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 4)
        self.assertEqual(len([box for box in response.boxes if box.shipping_method == 'UPS Ground']), 4)
    ...
    def test_86(self):
        input_data = {"zip": "64231", "items": [{"uid": "massive bulk bully sticks", "weight": 160, "qty": 3, "force_ground": True}, {"uid": "massive bulk kong filler", "weight": 160, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 4)
        self.assertEqual(len([box for box in response.boxes if box.shipping_method == 'UPS Ground']), 4)
    ...
    def test_92(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 10, "qty": 1}, {"uid": "big bag bully sticks", "weight": 14, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Mail Innovations')
    ...
    def test_93(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 8, "qty": 1}, {"uid": "sample bully sticks", "weight": 6, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        for box in response.boxes:
    ...
    def test_94(self):
        input_data = {"zip": "64231", "items": [{"uid": "kong filler", "weight": 32, "qty": 3}, {"uid": "bigger bag bully sticks", "weight": 32, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Ground')
    ...
    def test_95(self):
        input_data = {"zip": "64231", "items": [{"uid": "bulk bully sticks", "weight": 72, "qty": 3}, {"uid": "bulk kong filler", "weight": 72, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Ground')
    ...
    def test_96(self):
        input_data = {"zip": "64231", "items": [{"uid": "massive bulk bully sticks", "weight": 160, "qty": 1}, {"uid": "massive bulk kong filler", "weight": 160, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes[0].shipping_method, 'UPS Ground')
    ...
    def test_102(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 10, "qty": 1, "force_ground": True}, {"uid": "big bag bully sticks", "weight": 14, "qty": 3, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 4)
        for box in response.boxes:
    ...
    def test_103(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 8, "qty": 3, "force_ground": True}, {"uid": "sample bully sticks", "weight": 6, "qty": 1, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 4)
        for box in response.boxes:
    ...
    def test_104(self):
        input_data = {"zip": "64231", "items": [{"uid": "kong filler", "weight": 32, "qty": 1, "force_ground": True}, {"uid": "bigger bag bully sticks", "weight": 32, "qty": 3, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 4)
        for box in response.boxes:
    ...
    def test_105(self):
        input_data = {"zip": "64231", "items": [{"uid": "bulk bully sticks", "weight": 72, "qty": 3, "force_ground": True}, {"uid": "bulk kong filler", "weight": 72, "qty": 1, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 4)
        for box in response.boxes:
    ...
    def test_106(self):
        input_data = {"zip": "64231", "items": [{"uid": "massive bulk bully sticks", "weight": 160, "qty": 1, "force_ground": True}, {"uid": "massive bulk kong filler", "weight": 160, "qty": 3, "force_ground": True}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 4)
        for box in response.boxes:
    ...
    def test_112(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 10, "qty": 1, "force_ground": True}, {"uid": "big bag bully sticks", "weight": 14, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        self.assertEqual(len([box for box in response.boxes if box.shipping_method == 'UPS Ground']), 1)
    ...
    def test_113(self):
        input_data = {"zip": "64231", "items": [{"uid": "bag bully sticks", "weight": 8, "qty": 3, "force_ground": True}, {"uid": "sample bully sticks", "weight": 6, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 4)
        self.assertEqual(len([box for box in response.boxes if box.shipping_method == 'UPS Ground']), 3)
    ...
    def test_114(self):
        input_data = {"zip": "64231", "items": [{"uid": "kong filler", "weight": 32, "qty": 1, "force_ground": True}, {"uid": "bigger bag bully sticks", "weight": 32, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        for box in response.boxes:
    ...
    def test_115(self):
        input_data = {"zip": "64231", "items": [{"uid": "bulk bully sticks", "weight": 72, "qty": 3, "force_ground": True}, {"uid": "bulk kong filler", "weight": 72, "qty": 1}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 4)
        for box in response.boxes:
    ...
    def test_116(self):
        input_data = {"zip": "64231", "items": [{"uid": "massive bulk bully sticks", "weight": 160, "qty": 1, "force_ground": True}, {"uid": "massive bulk kong filler", "weight": 160, "qty": 3}]}
        response = shipping_optimization(input_data)
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 2)
        for box in response.boxes:
    ...
    def test_large_order_single_item(self):
        ...
        self.assertIsInstance(response, Order)
        self.assertEqual(len(response.boxes), 1)
        self.assertEqual(response.boxes.shipping_method, 'UPS Ground')
